...
/*
bool check(int i, int, j) //checa se eh posivel solucionar
{
	//pega o tamanho N do tabuleiro
	//for pra pegar o numero de inversoes
	//valida se N é par ou impar
	//se N for impar e inversao for impar, nao pode resolver, senao pode
	//se N for par, inversao + linha do quadrado branco, result igual a par, nao consegue resolver, result igual a impar, consegue resolver 
}
*/
